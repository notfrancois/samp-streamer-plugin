    ...
    case STREAMER_TYPE_OBJECT:
    {
        ...
        if (o != core->getData()->objects.end())
        {
            ...
            case MoveSpeed:
            {
                if (o->second->_move)
                {
                    Utility::storeFloatInNative(amx, params[4], o->second->_move->speed);
                    return 1;
                }
                return 0;
            }
            case MoveRX:
            {
                if (o->second->_move)
                {
                    Utility::storeFloatInNative(amx, params[4], std::get<0>(o->second->_move->rotation)[0]);
                    return 1;
                }
                return 0;
            }
            case MoveRY:
            {
                if (o->second->_move)
                {
                    Utility::storeFloatInNative(amx, params[4], std::get<0>(o->second->_move->rotation)[1]);
                    return 1;
                }
                return 0;
            }
            case MoveRZ:
            {
                if (o->second->_move)
                {
                    Utility::storeFloatInNative(amx, params[4], std::get<0>(o->second->_move->rotation)[2]);
                    return 1;
                }
                return 0;
            }
            case MoveX:
            {
                if (o->second->_move)
                {
                    Utility::storeFloatInNative(amx, params[4], std::get<0>(o->second->_move->position)[0]);
                    return 1;
                }
                return 0;
            }
            case MoveY:
            {
                if (o->second->_move)
                {
                    Utility::storeFloatInNative(amx, params[4], std::get<0>(o->second->_move->position)[1]);
                    return 1;
                }
                return 0;
            }
            case MoveZ:
            {
                if (o->second->_move)
                {
                    Utility::storeFloatInNative(amx, params[4], std::get<0>(o->second->_move->position)[2]);
                    return 1;
                }
                return 0;
            }
